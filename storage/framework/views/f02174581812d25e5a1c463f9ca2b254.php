...
<head>
    ...
    <title>Cuidados - HAS</title>
</head>
<body>
    <div class="titulo">
        <h2>Cuidados com a HAS</h2>
    </div>
    <div class="texto">
        <p>
            <h5 class="prevencao">- Prevenção</h5>
        ...
        <p>
            <h5 class="tratamento">- Tratamento</h5>
        ...
        <p>
            <h5 class="alimentacao">- Dicas de alimentação</h5>
            <p>
...
</html><?php /**PATH C:\Users\Felipe\Desktop\PI\Novo\HAS\resources\views/cuidados.blade.php ENDPATH**/ ?>